...
# run as for example
# python convert2hdf5.py ferritin_conc_gly_50_6 2 --repsperspot 4 --proc
...
if __name__ == "__main__":
    ...
    # filename = f"/cfs/data/pg/sdaqs/esrf-ebs/id10/sc5275/20220614/processed/h5-files/{datafolder}_{datasetnumber:04}"
    ...
    # xana.db['rep'] = xana.db['master'].apply(lambda x: get_rep(str(x), reps_per_spot=args.reps_per_spot))
