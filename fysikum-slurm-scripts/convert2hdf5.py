...
if __name__ == "__main__":
    ...
    #  get_rep(x, reps_per_spot=1)
    xana.db['rep'] = xana.db['master'].apply(get_rep, reps_per_spot=args.reps-per-spot)
    # xana.db['rep'] = xana.db['master'].apply(lambda x: get_rep(str(x), reps_per_spot=args.reps-per-spot))
